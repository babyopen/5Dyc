...
示例用法:
  ...
  # 指定数据文件
  python add_lottery_period.py -f lottery_data.json -p 2026107 -s 15 -z 3 -n 5 12 23 34 41 48
        """
    )
    ...
    parser.add_argument('-f', '--file', type=str, default='lottery_data.json',
                       help='数据文件路径（默认: lottery_data.json）')
